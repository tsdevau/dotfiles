#!/bin/zsh
# Key bindings for Zsh Line Editor (ZLE)
# This script configures key bindings for Zsh's line editor, enhancing the user experience
# by providing intuitive shortcuts for common actions like navigating history,
